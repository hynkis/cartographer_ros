...
options = {
  ...
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 1,             -- 1, 0
  num_multi_echo_laser_scans = 0,  -- 1
  num_subdivisions_per_laser_scan = 4, --3;  2(localization) 10(mapping)
  num_point_clouds = 0,
...
TRAJECTORY_BUILDER_2D.use_imu_data = true  -- imu use or not
...
TRAJECTORY_BUILDER_2D.num_accumulated_range_data = 10  -- 10 [Hz]

-- tuning

TRAJECTORY_BUILDER_2D.min_range = 0.15 -- 0.15 [m]
TRAJECTORY_BUILDER_2D.max_range = 25.0 -- 25.0
